...
const Nav = () => {
    ...
    return (
        ...
        <div className="fixed top-0 left-0 z-50 w-full  text-white p-4 flex
        justify-between items-center px-6 md:px-16 lg:px-36 py-5">
            <Link to ='/' className='max-md:flex-1'>
            <img src={assets.logo} alt="assets.logo" className='w-36 h-auto'/>
            </Link>
            ...
            <div className='md:flex items-center  gap-8'>
                ...
                {
                    !user ? (<button onClick={openSignIn} className='max-md:hidden bg-primary hover:bg-primary-dull tranistion duration-300
                text-white px-4 py-1 sm:px-7 sm:py-2 font-medium cursor-pointer rounded-md ml-4'>
                    Login
                </button>) :
                (<UserButton>
